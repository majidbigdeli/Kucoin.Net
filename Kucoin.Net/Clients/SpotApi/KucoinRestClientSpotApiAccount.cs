...
namespace Kucoin.Net.Clients.SpotApi
{
    ...
    internal class KucoinRestClientSpotApiAccount : IKucoinRestClientSpotApiAccount
    {
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<KucoinNewWithdrawal>> WithdrawAsync(WithdrawType withdrawType, string asset, string toAddress, decimal quantity, string? memo = null, bool? isInner = null, string? remark = null, string? network = null, FeeDeductType? deductType = null, CancellationToken ct = default)
        {
            asset.ValidateNotNull(nameof(asset));
